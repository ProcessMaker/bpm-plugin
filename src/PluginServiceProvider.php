<?php
namespace ProcessMaker\Plugins\Example;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use ProcessMaker\Plugins\Example\Http\Middleware\AddToMenus;

class PluginServiceProvider extends ServiceProvider
{

    // Assign the default namespace for our controllers
    protected $namespace = '\ProcessMaker\Plugins\Example\Http\Controllers';
    ...
    {
        // Load an example migration to create a sample table in our database
        $this->loadMigrationsFrom(__DIR__.'/../migrations');

        // Menus for BPM are done through middleware. We've included a sample middleware 
        ...
        $this->loadViewsFrom(__DIR__ . '/../resources/views/', 'plugins-processmaker-example');

        $this->publishes([
            __DIR__.'/../public' => public_path('plugin-processmaker-example'),
        ], 'public');
